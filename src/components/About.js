      ...
      <div className="pt-4" dir="rtl">
        ...
        <div className="p-5">
          ...
          <p>
            ...
            الرئيسية، يمكنك الظغط على الزر المحاذي لأي أية حتى تظهر لك خانة
            الكتابة، وحين تنتهي من الكتابة يمكنك الظغط على زر الحفظ، كل البيانات
            يتم تسجيلها في متصغحك وحذف سجل المتصفح قد يحذف أي بيانات قمت
            بتسجيلها هنا.
          </p>
          <h5>الشكر</h5>
          <br />
